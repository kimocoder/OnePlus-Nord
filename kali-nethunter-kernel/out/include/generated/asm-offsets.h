...
#define THREAD_CPU_CONTEXT 3600 /* offsetof(struct task_struct, thread.cpu_context) */
...
#define VMA_VM_MM 72 /* offsetof(struct vm_area_struct, vm_mm) */
#define VMA_VM_FLAGS 88 /* offsetof(struct vm_area_struct, vm_flags) */
